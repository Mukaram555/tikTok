...
class ProfileController extends GetxController{
  ...
  getUSerData() async{
    ...
    var followersDoc = await FirebaseFirestore.instance.collection('users').doc(_uid.value).collection("followers").get();
    ...
    FirebaseFirestore.instance.collection('users').doc(_uid.value).collection('followers').doc(
  ...
  followUser(String uid) async{
    ...
    var doc = await FirebaseFirestore.instance.collection('users').doc(uid).collection('followers').doc(FirebaseAuth.instance.currentUser!.uid).get();
