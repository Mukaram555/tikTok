        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  AuthController.instance.signUp(_userName.text, _emailController.text, _passwordController.text, AuthController.instance.proImg);
                },
                child: const Padding(
